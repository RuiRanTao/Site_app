...
import com.example.bottom.Daemon.DaemonOnceScat;
...
public class ScatterChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread daemon = new Thread(new DaemonOnceScat());
        // 必须在start之前设置为后台线程
...
//        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            {
                int su = 10*k + i;
                int val = orderList.get(su).val;
               switch (val){
                case 0:  values1.add(new Entry(i, k+1));
                    break;
                case 1:  values2.add(new Entry(i, k+1));
                    break;
               }
            }
        }
...
//        dataSets.add(set3);
    ...
    public ScatterChartActivity() {
        mainActivity = this;
    }

    public static ScatterChartActivity getMainActivity() {
        return mainActivity;
    }

    private static ScatterChartActivity mainActivity;
