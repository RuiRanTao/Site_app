...
public class Dao_user {
    ...
    public void insert(){
        ...
        String sql = "insert into " + Constants.USER_TABLE_NAME + "(floor,place,num,val) values(?,?,?,?,?)";
...
//            Toast.makeText(context, "执行出错，请检查SQL语句", Toast.LENGTH_SHORT).show();
    ...
    public List<Order> getAllDate(){
        ...
        try {
            ...
            // select * from Orders
            cursor = db.query(Constants.USER_TABLE_NAME, ORDER_COLUMNS, null, null, null, null, null);
